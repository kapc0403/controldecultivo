...
usuarios = User.create([{ nombre:'Sebastian Perez',rol:'estudiante',carrera:'Administracion',semestre:'5', email:'christopher@unac.edu.co', password:'123qwe',password_confirmation:'123qwe'},
                      ...
                      {nombre:'Melissa Perez',rol:'estudiante',carrera:'Enfermeria',semestre:'3', email:'melissa@unac1.edu.co', password:'123rty',password_confirmation:'123rty'},
                    ...
                    {nombre:'Andres Isaza',rol: 'estudiante',carrera:'APH',semestre:'2', email:'andres@unac.edu.co', password:'321asd',password_confirmation:'321asd'},
                      {nombre:'Lester Portillo',rol: 'profesor', email:'omar@cuemby.com', password:'369rty',password_confirmation:'369rty'},
...
cultivo = Farming.create! :user_id=> 9, :semilla=> 'frijol', :est_inscritos=> 10, recomendaciones:'Antes del cultivo utilice semillas sanas o certificadas. Prefiera las variedades de semillas resistentes o mejoradas.
...
cultivo = Farming.create! :user_id=>9, :semilla=> 'zanahoria',:est_inscritos=> 10, recomendaciones:'La siembra: A la hora de cultivar zanahorias debes saber que éstas prefieren el clima frío pero al mismo tiempo necesitan del sol. Lo ideal entonces es sembrarlas en un lugar en el que reciban sol durante todo el día.
...
cultivo = Farming.create! :user_id=>10, :semilla=> 'cilantro',:est_inscritos=> 10, recomendaciones:'Como las semillas del cilantro son dicotiledóneas, esto significa que obtendrás dos plantas por casa semilla que siembres. Tenlo en cuenta a la
...
cultivo = Farming.create! :user_id=>10, :semilla=> 'remolacha',:est_inscritos=> 10, recomendaciones:'Esta planta crece mejor en climas templados con una temperatura de entre 10 y 24°C. Debes tener en cuenta en lo que se refiere a como sembrar
