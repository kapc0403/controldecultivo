...
cultivo = Farming.create([{semilla:'frijol',recomendaciones:'Antes del cultivo utilice semillas sanas o certificadas. Prefiera las variedades de semillas resistentes o mejoradas.
                      ...
                      {semilla:'zanahoria',recomendaciones:'La siembra: A la hora de cultivar zanahorias debes saber que éstas prefieren el clima frío pero al mismo tiempo necesitan del sol. Lo ideal entonces es sembrarlas en un lugar en el que reciban sol durante todo el día.
                        ...
                        {semilla:'cilantro',recomendaciones:'Como las semillas del cilantro son dicotiledóneas, esto significa que obtendrás dos plantas por casa semilla que siembres. Tenlo en cuenta a la
                        ...
                        {semilla:'remolacha',recomendaciones:'Esta planta crece mejor en climas templados con una temperatura de entre 10 y 24°C. Debes tener en cuenta en lo que se refiere a como sembrar
